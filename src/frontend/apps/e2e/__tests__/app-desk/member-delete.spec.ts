...
test.describe('Members Delete', () => {
  test('it deletes himself when it is the last owner', async ({
    page,
    browserName,
  }) => {
  ...
  test('it deletes owner member', async ({ page, browserName }) => {
    await createTeam(page, 'member-delete-1', browserName, 1);
  ...
  test('it deletes owner member when admin', async ({ page, browserName }) => {
    await createTeam(page, 'member-delete-1', browserName, 1);
