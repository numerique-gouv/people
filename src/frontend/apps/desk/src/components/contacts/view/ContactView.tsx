...
import { ContactViewHeader } from '@/components/contacts/view/ContactViewHeader';
import { ContactViewPersonalData } from '@/components/contacts/view/ContactViewPersonalData';
import { ContactViewPublicData } from '@/components/contacts/view/ContactViewPublicData';
import { ContactViewShortcuts } from '@/components/contacts/view/ContactViewShortcuts';
