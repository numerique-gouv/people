...
def test_api_mail_domain__accesses_update_authenticated_unrelated():
    """
    Authenticated users should not be allowed to update a mail_domain access for a mail_domain to which
...
def test_api_mail_domain__accesses_update_authenticated_member():
    """Members of a mail_domain should not be allowed to update its accesses."""
    user = core_factories.UserFactory()
    mail_domain = factories.MailDomainFactory(users=[(user, "member")])
...
def test_api_mail_domain__accesses_update_administrator_except_owner():
    ...
    """
    user = core_factories.UserFactory()
    mail_domain = factories.MailDomainFactory(users=[(user, "administrator")])
    access = factories.MailDomainAccessFactory(
        domain=mail_domain,
...
def test_api_mail_domain__accesses_update_administrator_from_owner():
    ...
    access = factories.MailDomainAccessFactory(domain=mail_domain, user=other_user, role="owner")
    old_values = serializers.MailDomainAccessSerializer(instance=access).data
...
def test_api_mail_domain__accesses_update_owner_except_owner():
    ...
    """
    user = core_factories.UserFactory()
    mail_domain = factories.MailDomainFactory(users=[(user, "owner")])
...
def test_api_mail_domain__accesses_update_owner_for_owners():
    ...
    user = core_factories.UserFactory()
    mail_domain = factories.MailDomainFactory(users=[(user, "owner")])
    access = factories.MailDomainAccessFactory(domain=mail_domain, role="owner")
    old_values = serializers.MailDomainAccessSerializer(instance=access).data
...
def test_api_mail_domain__accesses_update_owner_self():
    ...
    access = factories.MailDomainAccessFactory(domain=mail_domain, user=user, role="owner")
    old_values = serializers.MailDomainAccessSerializer(instance=access).data
    ...
    factories.MailDomainAccessFactory(domain=mail_domain, role="owner")
