...
def test_api_users_authenticated_list_exclude_users_already_in_team(django_assert_num_queries):
    """
    ...
    # We can only find Nicole because Frank is already a member of the given team
