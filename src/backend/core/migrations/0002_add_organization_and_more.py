    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sirets', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=14), blank=True, default=list, size=None, validators=[core.models.validate_unique_siret], verbose_name='SIRET list')),
                ('domains', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=256), blank=True, default=list, size=None, validators=[core.models.validate_unique_domain], verbose_name='domains')),
            ],
            options={
                'verbose_name': 'organization',
                'verbose_name_plural': 'organizations',
                'db_table': 'people_organization',
                'constraints': [models.CheckConstraint(condition=models.Q(('sirets__len__gt', 0), ('domains__len__gt', 0), _connector='OR'), name='siret_or_domain', violation_error_message='An organization must have a SIRET or a domain.')],
            },
        ),
        migrations.AddField(
            model_name='team',
